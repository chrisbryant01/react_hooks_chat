      ...
      CometChat.addMessageListener(
        ...
        new CometChat.MessageListener({
          onTextMessageReceived: message => {
            ...
            NotificationManager.info("New Message from " + message.sender.name);
        ...
        {chat.map(chat => (
          <div key={chat.id} className="message">
            ...
            >
              <img
                src={`${
                  chat.receiver !== user.uid ? user.avatar : chat.sender.avatar
                }`}
                className="md-avatar rounded-circle chat-message-avatar-img"
                height="29"
                width="29"
                alt="User avatar"
              />
